...
func MarkdownReport(report Report) string {
	...
	fmt.Fprintf(&b, "## Corpus Summary\n\nTasks selected: **%d**. Results recorded: **%d**. Supported tasks: **%d total / %d passed / %d failed**. Excluded tasks: **%d**.\n\n", report.TasksRun, len(report.Results), report.Acceptance.SupportedTotal, report.Acceptance.SupportedPassed, report.Acceptance.SupportedFailed, report.Acceptance.ExcludedTotal)
